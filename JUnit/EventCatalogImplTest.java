...
public class EventCatalogImplTest {
    ...
    public void testFilterByEventCategory() {
        ...
        for (EventCategory category : categoryToIndices.keySet()) {
            actual = catalog.filterByEventCategory(category);

            for (Integer index : categoryToIndices.get(category)) {
                assertTrue(
            ...
            assertTrue(
                    ...
                    actual.size() == categoryToIndices.get(category).size());
        }
    }
